...
public class UserAccountEntity {
    ...
    @NotBlank
    @JsonIgnore  // hide password from responses
    ...
    @JsonIgnore  // ignore calendars in JSON input/output
    ...
    public UserAccountEntity(String fullName, String email, String password) {
